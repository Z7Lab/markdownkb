...
import { Loader2, Lightbulb, Square, Trash2, ChevronDown, ChevronRight, ShieldCheck } from "lucide-react"
...
export function PlannerTab() {
  const {
    plan, sources, approaches, reviews, refinedPlan,
    statusMessage, isPlanning, isRefined,
    generatePlan, stop, clear,
  } = usePlanner()
  ...
  function handleGenerate() {
    if (!query.trim() || isPlanning) return
    generatePlan(query)
  }
        ...
        <div className="flex flex-col items-center justify-start flex-1 gap-6 p-4 pt-[20vh]">
          ...
          <div className="flex gap-2 w-full max-w-2xl">
            <Input
              ...
              className="flex-1"
            />
            <Button onClick={handleGenerate} disabled={isPlanning || !query.trim()}>
              ...
              <div className="flex items-center gap-2 pb-2 border-b">
                ...
                <div className="ml-auto flex items-center gap-2">
                  ...
                  {!isPlanning && hasResults && (
                    <Button variant="outline" size="sm" className="h-7 px-2" onClick={() => { clear(); setQuery("") }}>
