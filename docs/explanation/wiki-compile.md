...
Feature flag: `wiki_compile`. API prefix: `/api/v1/wiki-compile`. Full endpoint docs: [api.md](../reference/api.md#wiki-compile). Plugin source and README: `app/plugins/wiki_compile/`.
