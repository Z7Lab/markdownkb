...
class RemoteEmbedder:
    ...
    def __init__(self, model: str, api_base: str, api_type: str = "ollama"):
        self._model = model
        self._api_base = api_base.rstrip("/")
        self._api_type = api_type
        self._dimensions: int | None = None
        logger.info(
            "Remote embedder: model=%s api_base=%s type=%s",
            model, api_base, api_type,
        )
...
def test_remote_embedding(model: str, api_base: str, api_type: str = "ollama") -> dict:
    """Test a remote embedding endpoint. Returns status dict."""
    try:
        embedder = RemoteEmbedder(model, api_base, api_type)
